...
func TestPacketEncode(t *testing.T) {
	...
	if !reflect.DeepEqual(ePktEncd[:4], buf[:4]) ||
		!reflect.DeepEqual(ePktEncd[20:], buf[20:n]) { // except authenticator which in RFC is randomly generated, ours is hash with secret on original
